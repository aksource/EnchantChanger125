...
public class EcRenderItemThrowable extends Render
{
    ...
    private boolean usevanillasprites;

    public EcRenderItemThrowable(int par1, float par2, boolean par3)
    {
        this.itemIconIndex = par1;
        this.RenderSize = par2;
        this.usevanillasprites = par3;
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if(this.usevanillasprites)
        	this.loadTexture("/gui/items.png");
        else
        	this.loadTexture("/mod_EnchantChanger/gui/items.png");
