...
public class EcEntityMeteo extends Entity
{
    ...
    private float Explimit = mod_EnchantChanger.MeteoPower;
    private float Size = mod_EnchantChanger.MeteoSize;
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        if (!this.worldObj.isRemote)
        {
			...
			*/
            this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, Explimit, true);
            this.setDead();
        }
    }
