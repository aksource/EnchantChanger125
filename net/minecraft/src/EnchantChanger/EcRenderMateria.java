...
public class EcRenderMateria implements IItemRenderer
{
	...
	public void renderMateria(ItemStack item, float x, float y, float z, float size, ItemRenderType type)
	{
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, mod_EnchantChanger.mc.renderEngine.getTexture(this.getTextuerfromEnch(item)));
...
//		GL11.glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
	...
	private String getTextureFromItemStack(ItemStack item)
	{
		if(item.getItem() instanceof EcItemMateria)
			return getTextuerfromEnch(item);
		else
			return "/mod_EnchantChanger/gui/materia10.png";
	}
	private String getTextuerfromEnch(ItemStack item)
	{
