...
public class EcEnchantmentTeleport extends Enchantment
{
    ...
    {
    	return this != par1Enchantment && par1Enchantment.effectId != mod_EnchantChanger.EnchantmentMeteoId &&par1Enchantment.effectId != mod_EnchantChanger.EndhantmentHolyId&&par1Enchantment.effectId != mod_EnchantChanger.EnchantmentThunderId;
    }
}