...
public class EcMasterMateriaRecipe implements IRecipe
{
	...
	public boolean matches(InventoryCrafting var1)
	{
		...
		if(materia[5] != null)
		{
			...
			{
				this.output = new ItemStack(mod_EnchantChanger.MasterMateria,1,3);
				flag = true;
			}
		}
		else if(materia[4] != null)
		{
			...
			{
				this.output = new ItemStack(mod_EnchantChanger.MasterMateria,1,1);
				flag = true;
			}
		}
		else if(materia[3] != null)
		{
			...
			{
				this.output = new ItemStack(mod_EnchantChanger.MasterMateria,1,4);
				flag = true;
			}
			else if(this.chekEnchmateria(materia, 4, 48, 51))
			{
				this.output = new ItemStack(mod_EnchantChanger.MasterMateria,1,5);
				flag = true;
			}
		}
		else if(materia[2] == null)
		{
			...
			{
				this.output = new ItemStack(mod_EnchantChanger.MasterMateria,1,2);
				flag = true;
			}
		}
		return flag;
