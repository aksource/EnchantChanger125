...
//    }
	...
	public void load() {
		...
		ItemMultiToolHolder5 = (new ItemMultiToolHolder(ItemIDShift - 256 + 1, 5)).setItemName(this.TextureDomain + "Holder5").setIconIndex(1);
		...
		ModLoader.addRecipe(new ItemStack(ItemMultiToolHolder5), new Object[]{"AAA","ABA", "CCC", Character.valueOf('A'), Item.ingotGold,Character.valueOf('B'),Block.chest, Character.valueOf('C'),Item.silk});
